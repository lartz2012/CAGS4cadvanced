export interface GemSpecies {
  id: string;
  name: string;
  family: string;
  basePricePerCarat: number; // Base wholesale 1ct price in USD (Placeholder if no seed)
  rarityExponent: number; // Carat price step curve sensitivity (0.3 to 1.0)
  clarityType: 'I' | 'II' | 'III'; // GIA Clarity Type
  ...
  specificGravity: number; // For dimension-to-weight cross check
}

export const SPECIES_CATALOG: Record<string, GemSpecies> = {
